...
flowchart TD
    ...
    E --> E2["python -m playwright install chromium"]
...
flowchart LR
    ...
    G --> I["PLAYWRIGHT_BROWSERS_PATH=0"]
    G --> J["HOST=0.0.0.0"]
...
| `PLAYWRIGHT_BROWSERS_PATH` | Yes | `0` | Keeps Playwright browser install available to the app bundle. |
