...
sequenceDiagram
    ...
    alt "Cache exists"
        ...
        Scraper->>Portal: "Submit year/semester filters"
...
| Attendance tables | Subject codes, subject names, monthly/day-wise marks, totals | Charts, tables, filters, chatbot |
